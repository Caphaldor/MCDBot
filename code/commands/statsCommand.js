                        ...
                        message.reply("",
                            {
                                embed: embed("SkyGiants stats of `" + args[1] + "`",
                                    ...
                                    "\n**Shutdowns:** " + hiveData.shutdowns, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                        ...
                        message.reply("",
                            {
                                embed: embed("Sploop stats of `" + args[1] + "`",
                                    ...
                                    raven +
                                    booster +
                                    torstein, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("DrawIt stats of " + args[1],
                                    ...
                                    "\n**Skips:** " + hiveData.skips, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("Block Party stats of `" + args[1] + "`",
                                    ...
                                    "\n**Elimiations:** " + hiveData.total_eliminations, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("Sky Wars stats of `" + args[1] + "`",
                                    ...
                                    timeAlive, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("Slaparoo stats of `" + args[1] + "`",
                                    ...
                                    "\n**Deaths:** " + hiveData.deaths, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("Trouble in Mineville stats of `" + args[1] + "`",
                                    ...
                                    "\n**Detective Points:** " + hiveData.d_points, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("Hide and Seek stats of `" + args[1] + "`",
                                    ...
                                    "\n**Deaths:** " + hiveData.deaths +
                                    "\n**Time Alive:** " + hiveData.timealive, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("DeathRun stats of `" + args[1] + "`",
                                    ...
                                    "\n**Kills:** " + hiveData.kills+
                                    "\n**Deaths:** " + hiveData.deaths +
                                    "\n**Checkpoints:** " + hiveData.totalcheckpoints, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("Gravity stats of `" + args[1] + "`",
                                    "**Points:** " + hiveData.points + " (" + hiveData.title + ")" +
                                    "\n**Victories:** " + hiveData.victories +
                                    "\n**Games Played:** " + hiveData.gamesplayed, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("Cowboys and Indians stats of " + args[1],
                                    ...
                                    "\n**Times Captured:** " + hiveData.captured, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("Electric Floor stats of `" + args[1] + "`",
                                    ...
                                    "\n**Blocks Activated:** " + hiveData.blocksactivated, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("Restaurant Rush stats of `" + args[1] + "`",
                                    ...
                                    "\n**Victories:** " + hiveData.victories +
                                    "\n**Games Played:** " + hiveData.gamesplayed +
                                    "\n**Tables Cleared:** " + hiveData.tablescleared, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("One in The Chamber stats of `" + args[1] + "`",
                                    ...
                                    "\n**Kills:** " + hiveData.kills+
                                    "\n**Deaths:** " + hiveData.deaths +
                                    "\n**Arrows Fired:** " + hiveData.arrowsfired, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("Music Masters stats of `" + args[1] + "`",
                                    ...
                                    "\n**Good Notes:** " + hiveData.notes_good, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("Cranked stats of `" + args[1] + "`",
                                    ...
                                    "\n**Air Strike Kills:** " + hiveData.airstrike_kills, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("The Herobrine stats of `" + args[1] + "`",
                                    ...
                                    "\n**Kills:** " + hiveData.kills+
                                    "\n**Deaths:** " + hiveData.deaths +
                                    "\n**Shards Captured:** " + hiveData.captures, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("Battery Dash stats of `" + args[1] + "`",
                                    ...
                                    "\n**Kills:** " + hiveData.kills+
                                    "\n**Deaths:** " + hiveData.deaths +
                                    "\n**Energy Collected:** " + hiveData.energy_collected, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("SG: Heroes stats of `" + args[1] + "`",
                                    ...
                                    "\n**Deathmatches:** " + hiveData.deathmatches +
                                    "\n**Crates Opened:** " + hiveData.crates_opened, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("Bed Wars stats of `" + args[1] + "`",
                                    ...
                                    "\n**Team Eliminations:** " + hiveData.teams_eliminated, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("PuMpKiNfEcTiOn stats of `" + args[1] + "`",
                                    ...
                                    "\n**Kills:** " + hiveData.kills, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
                        ...
                        message.reply("",
                            {
                                embed: embed("Survive The Night stats of `" + args[1] + "`",
                                    ...
                                    "\n**Looted Crates:** " + hiveData.looted_crates, "gold","https://crafatar.com/renders/body/"+ hiveData.UUID.toString() +" ?overlay", "https:/hivemc.com/player/" + hiveData.UUID.toString())
                             }).then(msg => checkDM(msg, message.channel.type, divN));
                    }else{
                        message.reply("",
                            {
